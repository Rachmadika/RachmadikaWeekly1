...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["send_message"])) {
    ...
    if (!empty($nama) && !empty($email) && !empty($pesan)) {
        $success_message = "Terima kasih, <strong>" . $nama . "</strong>! Pesan Anda mengenai '" . htmlspecialchars($subjek) . "' telah sukses terkirim. Tim kami akan merespons secepatnya.";
    }
}
?>
<!DOCTYPE html>
...
<title>Kontak - Web TI 2025</title>
...
<style>
  ...
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .map-frame {
    ...
    overflow: hidden;
    box-shadow: var(--shadow-soft);
    border: 1px solid rgba(159, 176, 124, 0.2);
  }
  .map-frame iframe {
    width: 100%;
    height: 100%;
...
<section class="page-hero">
  ...
  <div class="page-hero-inner reveal">
    ...
    <h1>Mari Berdiskusi &<br><em>Berkolaborasi</em></h1>
    <p>Hubungi sekretariat program studi Teknologi Informasi untuk informasi pendaftaran, akademik, riset, atau kemitraan industri.</p>
  </div>
</section>
...
<section class="contact-section">
  <div class="contact-grid">
    ...
    <div class="contact-info-list reveal">
      <div class="info-item">
        ...
        <div class="info-details">
          <h4>Kampus Utama</h4>
          <p>Jl. Raya Kampus TI No. 2025, Bukit Hijau, Kota Semarang, Jawa Tengah 50275</p>
        </div>
      </div>
      ...
      <div class="info-item">
        ...
        <div class="info-details">
          <h4>Surel Resmi</h4>
          <p><a href="mailto:info@ti2025.ac.id">info@ti2025.ac.id</a></p>
          <p><a href="mailto:akademik@ti2025.ac.id">akademik@ti2025.ac.id</a></p>
        </div>
      </div>
      ...
      <div class="info-item">
        ...
        <div class="info-details">
          ...
          <p>Telepon: (024) 7654321</p>
          <p>Whatsapp: <a href="https://wa.me/6285801307912" target="_blank">+62 858-0130-7912</a></p>
        </div>
      </div>
      ...
      <div class="info-item">
        ...
        <div class="info-details">
          ...
          <p>Sabtu - Minggu: Tutup (Layanan Libur)</p>
        </div>
      </div>
    </div>
    ...
    <div class="contact-card reveal">
      ...
      <p>Lengkapi formulir di bawah ini untuk mengirim pesan langsung ke layanan helpdesk kami.</p>
      ...
      <form action="kontak.php" method="POST">
        <div class="form-group">
          ...
          <input type="text" name="nama" id="nama" class="form-control" placeholder="Masukkan nama lengkap Anda" required autocomplete="off">
        </div>
        
        <div class="form-group">
          <label for="email">Alamat Email *</label>
          <input type="email" name="email" id="email" class="form-control" placeholder="namamu@domain.com" required autocomplete="off">
        </div>
        
        <div class="form-group">
          <label for="subjek">Subjek Pesan</label>
          <input type="text" name="subjek" id="subjek" class="form-control" placeholder="Contoh: Info Akademik, Kerja Sama" autocomplete="off">
        </div>
        
        <div class="form-group">
          <label for="pesan">Isi Pesan Anda *</label>
          <textarea name="pesan" id="pesan" class="form-control" placeholder="Tuliskan pesan Anda secara lengkap di sini..." required></textarea>
        </div>
...
<section class="map-container reveal">
  <div class="map-frame">
    <!-- Styled Embedded Map of Semarang/Central Java area matching the theme -->
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m13!1d126743.58627763683!2d110.34702434551101!3d-7.024724285818967!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e708b4ea7617f11%3A0x3027a764d11d840!2sKota%20Semarang%2C%20Jawa%20Tengah!5e0!3m2!1sid!2sid!4v1700000000000!5m2!1sid!2sid" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
  </div>
</section>
