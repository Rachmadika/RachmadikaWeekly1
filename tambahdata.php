...
<title>Tambah Data Mahasiswa - Web TI 2025</title>
...
<section class="page-hero">
  ...
  <div class="page-hero-inner reveal">
    <span class="badge"><span class="dot"></span> Input Modul</span>
    <h1>Tambah Data <em>Mahasiswa</em></h1>
  </div>
</section>
  ...
  <div class="form-card reveal">
    <form action="" method="post" enctype="multipart/form-data">
      ...
      <div class="form-group">
        ...
        <input type="text" name="nim" id="nim" class="form-control" placeholder="Masukkan NIM" required autocomplete="off">
      </div>
      
      <div class="form-group">
        <label for="prodi">Program Studi *</label>
        <input type="text" name="prodi" id="prodi" class="form-control" placeholder="Teknologi Informasi / Sistem Informasi" required autocomplete="off">
      </div>
      
      <div class="form-group">
        <label for="email">Alamat Email *</label>
        <input type="email" name="email" id="email" class="form-control" placeholder="email@contoh.com" required autocomplete="off">
      </div>
      ...
      <div class="btn-group">
        ...
        <button type="submit" name="submit" class="btn btn-primary" onclick="return confirm('Apakah Anda yakin data yang diisi sudah benar?');">
